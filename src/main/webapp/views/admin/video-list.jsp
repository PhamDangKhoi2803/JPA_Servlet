...
%>
 ...
 <form action="/admin/videos/save" method="get" enctype ="multipart/form-data">
        <input type="text" id="categoryid" name="categoryid" value="<%= categoryId != null ? categoryId : "" %>" readonly />
